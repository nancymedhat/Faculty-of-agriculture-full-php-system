...
$sql3= "SELECT c.id ,c.Course_code , t.drs_names , c.name ,c.names , c.hours from course c , rcourse r , $tableNam t WHERE c.id =r.courseid and 
r.student_id = '$iid' and c.Course_code = t.Course_code";
 mysqli_query($db,"SET CHARACTER SET utf8");
           $result = mysqli_query($db,$sql3);

           $sq ="SELECT * from exams e , rcourse r WHERE e.cid =r.courseid and r.student_id='$iid' ";
           mysqli_query($db,"SET CHARACTER SET utf8");
