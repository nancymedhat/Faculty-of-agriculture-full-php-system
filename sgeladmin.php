...
$query2="SELECT * from users WHERE Student_reg='$uid'";
...
<hr>
<strong><div>
<label style="margin-left:70%; margin-top :1%;height:5%; width:100%;font-size:100%;color:black;">الاسم: <?php echo $name;?>
